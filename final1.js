...
async function addExpense(event) {
    ...
    try {
        const response = await axios.post("https://crudcrud.com/api/1d6c6de888934c068c6ed21f93b672ec/addProduct", obj)
...
window.addEventListener("DOMContentLoaded", () => {
    async function reload() {
        try {
            const response = await axios.get("https://crudcrud.com/api/1d6c6de888934c068c6ed21f93b672ec/addProduct")
...
async function deleteUser(userId) {
    try {
        const response = await axios.delete(`https://crudcrud.com/api/1d6c6de888934c068c6ed21f93b672ec/addProduct/${userId}`)
        console.log(response)
